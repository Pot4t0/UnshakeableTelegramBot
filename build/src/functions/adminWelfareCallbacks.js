...
const sendNotInReminder_2 = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield ctx.reply(`Write down the reminder msg that you want to send to not in wishes`, {
        reply_markup: {
            force_reply: true,
        },
    });
...
const seeWelfareEvents = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    yield ctx.editMessageReplyMarkup({ reply_markup: { inline_keyboard: [] } });
    const allWelfareEvents = yield db_init_1.Database.getRepository(tableEntity_1.Events).find();
...
const deleteWelfareEvent_1 = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    yield ctx.editMessageReplyMarkup({ reply_markup: { inline_keyboard: [] } });
    const delevent = yield db_init_1.Database.getRepository(tableEntity_1.Events).find();
...
const editWelfareEventMenu = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getEvents = yield db_init_1.Database.getMongoRepository(tableEntity_1.Events).find({
        eventNames: name,
    });
...
const editWelfareEventName_2 = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield db_init_1.Database.getMongoRepository(tableEntity_1.Events).updateOne({ id: ctx.session.id }, { $set: { eventName: newEventName } });
...
const editWelfareEventDate_2 = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield db_init_1.Database.getMongoRepository(tableEntity_1.Events).updateOne({ id: ctx.session.id }, { $set: { eventDate: newEventDate } });
...
const editWelfareNotAllowedUser_2 = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield db_init_1.Database.getMongoRepository(tableEntity_1.Events).updateOne({ id: ctx.session.id }, { $set: { notAllowedUser: selectedName } });
...
const manageWelfareTeam = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userList = yield db_init_1.Database.getMongoRepository(tableEntity_1.Names).find({
        where: {
            role: { $in: ['welfare'] },
        },
    });
    const icList = yield db_init_1.Database.getMongoRepository(tableEntity_1.Names).find({
        where: {
            role: { $in: ['welfareIC'] },
        },
    });
...
const addWelfareMember_1 = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    yield ctx.editMessageReplyMarkup({ reply_markup: { inline_keyboard: [] } });
    const namelist = yield db_init_1.Database.getMongoRepository(tableEntity_1.Names).find({
        where: {
...
const addWelfareMember_2 = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userRoleList = yield (yield db_init_1.Database.getMongoRepository(tableEntity_1.Names).find({ nameText: selectedName }))
        .flatMap((n) => n.role)
        .flat()
        .concat(['welfare']);
    console.log(userRoleList);
    yield db_init_1.Database.getMongoRepository(tableEntity_1.Names).updateOne({ nameText: selectedName }, { $set: { role: userRoleList } });
...
const delWelfareMember_2 = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let userRoleList = yield (yield db_init_1.Database.getMongoRepository(tableEntity_1.Names).find({ nameText: selectedName })).flatMap((n) => n.role);
...
const editWelfareMember_2 = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let editRole = yield (yield db_init_1.Database.getMongoRepository(tableEntity_1.Names).find({ nameText: selectedName })).flatMap((n) => n.role);
    let changeRole = '';
    ...
    yield db_init_1.Database.getMongoRepository(tableEntity_1.Names).updateOne({ nameText: selectedName }, { $set: { role: editRole } });
