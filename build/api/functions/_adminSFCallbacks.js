...
exports.sendSpecificReminder_3 =
  exports.sendSpecificReminder_2 =
  exports.sendSpecificReminder_1 =
  exports.sendNotInReminder_3 =
  exports.sendNotInReminder_2 =
  exports.sendNotInReminder_1 =
  exports.reminderManagement =
    void 0;
...
const sendNotInReminder_3 = (ctx) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < user.length; i++) {
      const name = yield _db_init_1.Database.getMongoRepository(
        _tableEntity_1.Names
      ).find({
        sfrow: user[i],
      });
      yield (0, _db_functions_1.sendMessageUser)(
        name[0].teleUser,
        reminder,
        ctx
      );
...
const sendSpecificReminder_1 = (ctx) =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield ctx.editMessageReplyMarkup({ reply_markup: { inline_keyboard: [] } });
    const name = yield _db_init_1.Database.getRepository(
      _tableEntity_1.Names
    ).find();
    const inlineKeyboard = new grammy_1.InlineKeyboard(
      name.map((n) => [
...
const sendSpecificReminder_2 = (ctx) =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield ctx.editMessageReplyMarkup({ reply_markup: { inline_keyboard: [] } });
    const telegramUser = yield ctx.update.callback_query.data.substring(
