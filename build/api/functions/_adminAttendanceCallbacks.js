...
exports.delAttendanceeSheet_Execution = exports.delAttendanceeSheet_CfmMessage = exports.delAttendanceSheet = exports.addAttendanceSheet_CreateSpecialEventSheet = exports.addAttendanceSheet_SpecialEventDateMessage = exports.addAttendanceSheet_CreateNoLGEventSheet = exports.addAttendanceSheet_NoLGEventWEDateMessage = exports.addAttendanceSheet_CreateLGEventSheet = exports.addAttendanceSheet_LGEventWEDateMessage = exports.addAttendanceSheet = exports.adminAttendance = void 0;
...
const adminAttendance = (bot) => {
    ...
    // Add No LG Event
    bot.callbackQuery('noLGAddAttendance', exports.addAttendanceSheet_NoLGEventWEDateMessage);
    // Add Special Event
...
const addAttendanceSheet_CreateLGEventSheet = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (lgDate && weDate) {
        ...
        if (sheetExist == undefined) {
            ...
            yield createEventDBDoc(title, weDate);
        }
        else {
...
exports.addAttendanceSheet_NoLGEventWEDateMessage = addAttendanceSheet_NoLGEventWEDateMessage;
...
// Special Event Date
// Used in _botOn_functions.ts in botOntype = 26
...
// Used in _botOn_functions.ts in botOntype = 27
const addAttendanceSheet_CreateSpecialEventSheet = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (sheetExist == undefined) {
        ...
        if (event_date && event_name) {
            ...
            yield createEventDBDoc(title, event_date);
            yield ctx.reply(`${title} sheet has been created`);
        }
        else {
...
const unarchiveAttendance_Execution = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (archiveSheet) {
        if (date) {
            ...
            yield createEventDBDoc(callback, date);
