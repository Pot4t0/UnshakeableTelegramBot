...
exports.settingsAnnouncements_Output = exports.settings = void 0;
...
const settings = (bot) => {
    bot.callbackQuery('settingsAnnouncements', settingsAnnouncements_Input); //Settings Announcements Input
...
const settingsAnnouncements_Output = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (announcement == null || ctx.session.botOnType == null) {
        (0, exports.settingsAnnouncements_Output)(ctx);
    }
    else {
        ...
        yield Promise.all(sendUsers.map((n) => __awaiter(void 0, void 0, void 0, function* () {
            yield _index_1.dbMessaging.sendMessageUser(n, announcement, ctx);
        })));
